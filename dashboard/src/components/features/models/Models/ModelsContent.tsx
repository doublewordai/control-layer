                          ...
                          {model.alias.length > 30 ? (
                            <HoverCard openDelay={200} closeDelay={100}>
                              <HoverCardTrigger asChild>
                                <CardTitle className="text-lg truncate max-w-[460px] md:max-w-[420px] lg:max-w-[260px] xl:max-w-[300px] 2xl:max-w-[230px] 3xl:max-w-[340px] 4xl:max-w-[500px] break-all hover:opacity-70 transition-opacity cursor-default">
                                  {model.alias}
                                </CardTitle>
                              </HoverCardTrigger>
                              <HoverCardContent
                            ...
                            <CardTitle className="text-lg truncate max-w-[460px] md:max-w-[420px] lg:max-w-[260px] xl:max-w-[300px] 2xl:max-w-[230px] 3xl:max-w-[340px] 4xl:max-w-[500px] break-all">
                              {model.alias}
                            </CardTitle>
                          )}
                      ...
                      <CardDescription className="flex items-center gap-1.5 min-w-0">
                        ...
                        <span className="flex items-center gap-1.5 min-w-0">
                          {model.model_name.length > 30 ? (
                            <HoverCard openDelay={200} closeDelay={100}>
                              <HoverCardTrigger asChild>
                                <span className="truncate max-w-[330px] md:max-w-[330px] lg:max-w-[180px] xl:max-w-[200px] 2xl:max-w-[150px] 3xl:max-w-[200px] 4xl:max-w-[300px] hover:opacity-70 transition-opacity">
                                  {model.model_name}
                                </span>
                              </HoverCardTrigger>
                              <HoverCardContent
                            ...
                            <span className="truncate max-w-[330px] md:max-w-[330px] lg:max-w-[180px] xl:max-w-[200px] 2xl:max-w-[150px] 3xl:max-w-[200px] 4xl:max-w-[300px] ">
                              {model.model_name}
                            </span>
                          )}
                          <span>•</span>
                          {(() => {
                            ...
                            return endpointName.length > 25 ? (
                              <HoverCard openDelay={200} closeDelay={100}>
                                <HoverCardTrigger asChild>
                                  <span className="truncate max-w-[300px] md:max-w-[300px] lg:max-w-[150px] xl:max-w-40 2xl:max-w-[150px] 3xl:max-w-[180px] 4xl:max-w-[300px] hover:opacity-70 transition-opacity">
                                    {endpointName}
                                  </span>
                                </HoverCardTrigger>
                                <HoverCardContent
                              ...
                              <span className="truncate max-w-[300px] md:max-w-[300px] lg:max-w-[150px] xl:max-w-40 2xl:max-w-[150px] 3xl:max-w-[180px] 4xl:max-w-[300px]">
                                {endpointName}
                              </span>
                            );
                          })()}
