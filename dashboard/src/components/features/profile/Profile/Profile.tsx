...
export const Profile: React.FC = () => {
  ...
  const { isOrgContext, activeOrganization } = useOrganizationContext();
                  ...
                  <div className="flex items-center text-sm">
                    ...
                    <HoverCard openDelay={150} closeDelay={200}>
                      ...
                      <HoverCardContent side="top" align="start">
                        <p className="text-sm">
                          Zero data retention is enabled for your account:
                          request and response payloads are not retained.
                        </p>
                      </HoverCardContent>
                    </HoverCard>
                  </div>
            ...
            {isOrgContext ? (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mt-6">
                ...
                <div className="flex items-start gap-3 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                  ...
                  <p className="text-sm text-blue-800">
                    Notification settings are managed at the organization level while you are in an organization context.{" "}
              ...
              <div className="mt-6">
                <NotificationSettings
                  userId="current"
                  showPlatformScope={isPlatformManager}
                />
              </div>
            )}
          </div>
