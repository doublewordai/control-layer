  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="flex flex-col">
        <span className="text-sm">{formatTimestamp(row.original.started_at)}</span>
...
export function System() {
  ...
  // Settings state
  const { toggleFeature, isFeatureEnabled, updateDemoConfig, settings } = useSettings();
              ...
              <div className="flex items-center justify-center h-32">
                <div className="text-center">
                  <div
                    ...
                    aria-label="Loading"
                  ></div>
                  <p className="text-sm text-doubleword-neutral-600">Loading daemons...</p>
                </div>
              </div>
            ) : daemons.length === 0 ? (
