...
pub struct OrganizationUpdate {
    ...
    /// refused. Same permission gate as `zero_data_retention`. Omit to leave
    /// unchanged; an empty list revokes all.
    ...
    /// applies where the organisation holds it and the model offers it. Same
