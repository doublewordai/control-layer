...
impl From<(Vec<Role>, User)> for UserDBResponse {
    fn from((roles, user): (Vec<Role>, User)) -> Self {
        Self {
            ...
            image_normalization_enabled: user.image_normalization_enabled,
        }
    }
}
...
impl<'c> Repository for Users<'c> {
    ...
    async fn get_by_id(&mut self, id: Self::Id) -> Result<Option<Self::Response>> {
        let result = sqlx::query!(
            ...
            GROUP BY u.id, u.username, u.email, u.display_name, u.avatar_url, u.auth_source, u.created_at, u.updated_at, u.last_login, u.is_admin, u.password_hash, u.external_user_id, u.payment_provider_id, u.is_deleted, u.is_internal, u.batch_notifications_enabled, u.first_batch_email_sent, u.low_balance_notification_sent, u.low_balance_threshold, u.auto_topup_amount, u.auto_topup_threshold, u.auto_topup_monthly_limit, u.auto_topup_limit_notification_sent, u.user_type, u.image_normalization_enabled
            "#,
            id
        )
    ...
    async fn update(&mut self, id: Self::Id, request: &Self::UpdateRequest) -> Result<Self::Response> {
        ...
        let user;
        {
            ...
            UPDATE users SET
                ...
                END,
                image_normalization_enabled = COALESCE($14, image_normalization_enabled),
                updated_at = NOW()
            WHERE id = $1
            RETURNING *
            "#,
                ...
                request.image_normalization_enabled,
            )
