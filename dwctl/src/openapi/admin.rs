...
#[openapi(
    ...
    paths(
        ...
        api::handlers::deployments::update_model_component_layout,
    ...
    components(
        schemas(
            ...
            api::models::deployments::ModelComponentLayoutEntry,
            api::models::deployments::ModelComponentLayoutUpdate,
