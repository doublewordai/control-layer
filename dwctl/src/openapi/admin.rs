...
#[openapi(
    ...
    paths(
        ...
        api::handlers::cache_pricing::get_cache_pricing,
        api::handlers::cache_pricing::enable_cache_pricing,
        api::handlers::cache_pricing::disable_cache_pricing,
        ...
        api::handlers::deployments::create_model_group,
        api::handlers::deployments::update_model_group,
        api::handlers::deployments::delete_model_group,
    ...
    components(
        schemas(
            ...
            api::models::cache_pricing::CachePricingUpdateRequest,
            api::models::cache_pricing::CachePricingResponse,
            ...
            api::models::deployments::ModelGroupCreate,
            api::models::deployments::ModelGroupUpdate,
            api::models::deployments::ModelGroupResponse,
            api::models::deployments::ModelGroupDeleteQuery,
