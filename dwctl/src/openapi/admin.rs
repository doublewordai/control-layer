...
#[openapi(
    ...
    paths(
        ...
        api::handlers::composite_models::list_composite_models,
        api::handlers::composite_models::create_composite_model,
        api::handlers::composite_models::get_composite_model,
        api::handlers::composite_models::update_composite_model,
        api::handlers::composite_models::delete_composite_model,
        api::handlers::composite_models::get_composite_model_components,
        api::handlers::composite_models::add_composite_model_component,
        api::handlers::composite_models::update_composite_model_component,
        api::handlers::composite_models::remove_composite_model_component,
        api::handlers::composite_models::get_composite_model_groups,
        api::handlers::composite_models::add_composite_model_group,
        api::handlers::composite_models::remove_composite_model_group,
    ...
    components(
        schemas(
            ...
            api::models::composite_models::CompositeModelCreate,
            api::models::composite_models::CompositeModelUpdate,
            api::models::composite_models::CompositeModelResponse,
            api::models::composite_models::CompositeModelComponentDefinition,
            api::models::composite_models::CompositeModelComponentResponse,
