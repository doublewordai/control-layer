...
batches:
  ...
  daemon:
    ...
    # By default, uses SLA-aware retry: retries until approaching the batch deadline
    # with guaranteed minimum retries (min_retries=3, stop_before_deadline_ms=3600000)
    #
    # To customize SLA-aware retry, uncomment both parameters:
    # min_retries: 3 # Minimum retries guaranteed regardless of deadline
    # stop_before_deadline_ms: 3600000 # Stop retrying 1 hour (3600000ms) before batch deadline
    #
    # To use legacy fixed retry limit instead, uncomment:
