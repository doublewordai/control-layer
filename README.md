...
batches:
  ...
  daemon:
    ...
    # Timeout Settings
    # timeout_ms: 600000 # DEPRECATED: splits into 90% header_timeout_ms, 10% body_timeout_ms
    header_timeout_ms: 86400000 # Max time waiting for response headers (24 hours)
